...
for vrty in all_varities:
    ...
    train_p = '../../Data/Augmented/train_rotated_120_degree'	

    # Validation set images directory path    
    test_p = '../../Data/Augmented/test_rotated_120_degree/'+vrty	


    # Saved model directory path
    model_p = 'Model_rotated_120_degree_24_epochs'    
    ...
    for vrrt in all_varities:
        if vrrt in d:
            ...
            print (vrrt+": {}%".format(acc)) # Ashutosh - fixed
        else:
            print(vrrt+": 0%")
