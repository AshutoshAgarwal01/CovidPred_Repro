...
try:
    ...
    # Total iterations
    final_iter = 400 # (For 24 Epochs, 120 degree rotated images based models)
    ...
    train_path=r'../../Data/Augmented/train_rotated_120_degree'
    ...
    def train(num_iteration):
        ...
        for i in range(total_iterations,
            ...
            if i % int(data.train.num_examples/batch_size) == 0: 
                ...
                saver.save(session, 'Model_rotated_120_degree_24_epochs/trained_model') ### To save model with the name specified in this line
...
## Graph Title 
plt.title("Rotated 120 degree images based model [24 epochs based]")
...
plt.savefig("./rotated_120_degree_24_epochs.png")
