...
logging.basicConfig(level=logging.DEBUG, filename=f"training_140_logfile_{tstamp}.txt", filemode="w+", format="%(asctime)-15s %(levelname)-8s %(message)s")
...
datasets = ['train_rotated_140_degree']
